package com.example.memoryleaktest.domain

data class StaticStudent(val name: String, val age: Int, val bio: String) {
    companion object {
        ...
        fun init(name: String, age: Int) = StaticStudent(name, age, DEFAULT_BIO)
    }
}
